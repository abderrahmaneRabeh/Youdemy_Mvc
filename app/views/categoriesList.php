        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mx-auto py-0">
                    <a href="./index.php?url=home" class="nav-item nav-link">Accueil</a>
                    <a href="./index.php?url=coursesList" class="nav-item nav-link">Cours</a>
                    <a href="./index.php?url=categoryList" class="nav-item nav-link active">Categories</a>
                </div>
                ...
                <ul class="pagination justify-content-center mb-0">
                    <li class="page-item">
                        <?php if ($currentPage > 1): ?>
                            <a class="page-link" href="?url=categoryList&page=<?= $currentPage - 1 ?>"><i
                    ...
                    <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                        ...
                        <?php else: ?>
                            <li class="page-item"><a class="page-link" href="?url=categoryList&page=<?= $i ?>"><?= $i ?></a>
                            </li>
                        <?php endif; ?>
                    <?php endfor; ?>
